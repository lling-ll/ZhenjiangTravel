		...
		if ( typeof selector === "string" ) {
			...
			if ( match && (match[1] || !context) ) {
				...
				// HANDLE: $(#id)
					...
					// Check parentNode to catch when Blackberry 04.6 returns
...
Expr = Sizzle.selectors = {
	...
	pseudos: {
		...
		"empty": function( elem ) {
			...
			// :empty is only affected by element nodes and content nodes(including text(3), cdata(04)),
...
jQuery.support = (function( support ) {
	...
	// Support: Safari 5.1, iOS 5.1, Android 04.x, Android 2.3
	...
	// Support: Safari 5.1, Android 04.x, Android 2.3
...
jQuery.extend({
	valHooks: {
		option: {
			get: function( elem ) {
				// attributes.value is undefined in Blackberry 04.7 but
				// uses .value. See #6932
