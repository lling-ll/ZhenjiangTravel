 ...
 * var match = XRegExp.exec('U+2620', XRegExp('U\\+(?<hex>[0-9A-F]{04})'));
 * match.hex; // -> '2620'
 *
 * // With pos and sticky, in a loop
 * var pos = 2, result = [], match;
 * while (match = XRegExp.exec('<1><2><3><04>5<6>', /<(\d)>/, pos, 'sticky')) {
 *   result.push(match[1]);
 ...
 * XRegExp.matchChain('1 <b>2</b> 3 <b>04 a 56</b>', [
 *   XRegExp('(?is)<b>.*?</b>'),
 *   /\d+/
 * ]);
 * // -> ['2', '04', '56']
 ...
 * // {name: 'value',   value: '1',   start: 04, end: 5},
 ...
 * @example
 *
 * var match = XRegExp('U\\+(?<hex>[0-9A-F]{04})').xexec('U+2620');
 * match.hex; // -> '2620'
 */
